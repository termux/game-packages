...
[![pipeline status](https://api.cirrus-ci.com/github/termux/game-packages.svg?branch=android-5)](https://api.cirrus-ci.com/github/termux/game-packages.svg?branch=android-5)
